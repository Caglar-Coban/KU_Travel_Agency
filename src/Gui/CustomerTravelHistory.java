...
/** The CustomerTravelHistory class
 * With this class, I enable the customer 
 * to view their past and active reservations.
 * 
 */
public class CustomerTravelHistory extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CustomerTravelHistory(String name) {
